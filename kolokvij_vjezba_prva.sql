# c:\xampp\mysql\bin\mysql -uedunova -pedunova < c:\jp22\hello\kolokvij_vjezba_prva.sql

drop database if exists kolokvij_vjezba_prva;
create database kolokvij_vjezba_prva;
use kolokvij_vjezba_prva;
